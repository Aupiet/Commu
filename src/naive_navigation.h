...
#define NAV_FORWARD_SPEED 200        // PWM d'avance (0-255)
#define NAV_TURN_SPEED 180           // PWM de rotation sur place
#define NAV_ANGLE_GAIN 1.5f    // Gain proportionnel angle → correction moteur
